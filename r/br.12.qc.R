...
n_noexp = apply(e1, 1, myfunc <- function(x) sum(x<0.3))
...
p1 = ggplot(tp2) +
  ...
  scale_x_continuous(name = 'PC1 (37.8%)') +
  scale_y_continuous(name = 'PC2 (6.8%)') +
